/*
 * DO NOT EDIT THIS FILE - it was originally generated by Glade.
 */
                                        ...
                                        const gchar     *widget_name)
{
  ...
  if (xml == NULL)
    g_warning ("XML tree is a null pointer");

  found_widget = glade_xml_get_widget (xml, widget_name);

  if (found_widget == NULL)
    found_widget = (GtkWidget*)
      gtk_object_get_data (GTK_OBJECT (widget), widget_name);
